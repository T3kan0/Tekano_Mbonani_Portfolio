...
with col1:
    with st.expander(":blue[Research Slides]: Evaluating the effectiveness and implementation of skills, principles and strategies in tutor training."):
        ...
        display_pdf("/Users/tekanombonani/Desktop/A-STEP/2242/WebApp/Portfolio/pages/siyaphumelela.pdf", height=iframe_height, width=500)  # Adjust width here as needed        
with col2:
    with st.expander(":blue[Research Paper]: Physical inference from the temporal analysis of PKS 1510-089 during the 2014 - 2015 multi-wavelength flaring events."):
        ...
        display_pdf("/Users/tekanombonani/Desktop/A-STEP/2242/WebApp/Portfolio/pages/HEASA2022_053.pdf", height=iframe_height, width=500)  # Adjust width here as needed

...
st.markdown("""
    ...
    <div class="edu-card">
        ...
        <ul>
            <li><b>Thesis:</b> _Probing the inner jet regions and emission mechanisms of the flat spectrum radio quasars 3C 279 and PKS 1510-089 through temporal and spectral variability studies_</li>
